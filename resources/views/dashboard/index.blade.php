                ...
                <div class="bg-white p-4 h-100" style="border-radius: var(--radius-lg); box-shadow: var(--shadow-sm); border: 1px solid var(--gray-200);">
                    ...
                    <form action="{{ route('dashboard.konsultasi.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="pesan" rows="2" class="form-control text-dark" placeholder="Jelaskan secara singkat apa yang ingin didiskusikan..." required></textarea>
                        </div>
                ...
                <div class="bg-white p-4 h-100" style="border-radius: var(--radius-lg); box-shadow: var(--shadow-sm); border: 1px solid var(--gray-200);">
                    ...
                    @if(isset($riwayatKonsultasi) && $riwayatKonsultasi->count() > 0)
                        <div style="max-height: 250px; overflow-y: auto; padding-right: 10px;">
                            @foreach($riwayatKonsultasi as $konsultasi)
                                <div class="border-start border-3 border-{{ $konsultasi->status == 'menunggu' ? 'warning' : ($konsultasi->status == 'dijadwalkan' ? 'primary' : 'success') }} ps-3 mb-3">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted mt-2 mb-0" style="font-size: 0.9rem;">Belum ada riwayat pengajuan konsultasi.</p>
                        </div>
                    @endif
                </div>
            </div>
