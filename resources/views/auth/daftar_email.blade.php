...
@section('content')
    ...
    <!-- ===== POPUP VERIFIKASI GOOGLE ===== -->
    <div class="popup-window" id="google-popup" style="display: none;">
            ...
            <div class="card">
                ...
                <div class="card-body" style="text-align: center;">
                    <p style="color: var(--gray-600); margin-bottom: 24px;">
                        Silakan verifikasi dengan akun Google Anda untuk mendaftar seperti daftar via NIP
                    </p>
                    <button type="button" class="btn-google-verify" id="btnGoogleVerifyPopup" onclick="googleSignIn()" style="margin: 0 auto; display: inline-flex;">
                    ...
                    <div style="margin-top: 20px;">
                        <button type="button" class="btn-modern btn-danger-modern" style="padding: 10px 20px; border-radius: 50px;" onclick="cancelAndGoBack()">
                            Batal
                        </button>
                    </div>
                </div>
                    ...
                    <div class="register-card" data-aos="fade-up">
                        ...
                        <div class="register-card-body">
                            <form action="/prosesdaftar" method="POST" id="frmdaftar">
                                ...
                                <button class="btn-modern btn-primary-modern btn-full-width" type="submit" id="btnSubmit" disabled>
                                ...
                                <p class="submit-hint" id="submitHint">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display:inline-block; vertical-align:middle; color: var(--primary);">
                                        <circle cx="12" cy="12" r="10"></circle>
                                        <line x1="12" y1="16" x2="12" y2="12"></line>
                                        <line x1="12" y1="8" x2="12.01" y2="8"></line>
                                    </svg>
                                    Silakan verifikasi akun Google terlebih dahulu untuk mendaftar
                                </p>
                            </form>
                        </div>
                    </div>
